...
namespace Exam
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            products[3] = new MobilePhone("M001", "Phone 1", 500.21, "Manufacturer 1");
            products[4] = new MobilePhone("M002", "Phone 2", 80.124, "Manufacturer 2");
            products[5] = new MobilePhone("M003", "Phone 3", 120.345, "Manufacturer 3");
